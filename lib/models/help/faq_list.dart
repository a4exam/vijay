...
class Data {
  ...
  Data({this.questionEng, this.questionHi, this.solutionEng, this.solutionHi});

  Data.fromJson(Map<String, dynamic> json) {
    questionEng = json['question_eng'];
    questionHi = json['question_hi'];
    solutionEng = json['solution_eng'];
    solutionHi = json['solution_hi'];
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = Map<String, dynamic>();
    data['question_eng'] = this.questionEng;
    data['question_hi'] = this.questionHi;
    data['solution_eng'] = this.solutionEng;
